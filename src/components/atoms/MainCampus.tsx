...
import DormsBuilding from './DormsBuilding'

const RitchieHallSign: React.FC<{ onClick: () => void }> = ({ onClick }) => (
  <ClickableContainer id="ritchie-hall-sign" onClick={onClick}>
    <rect
      x="490.427"
      y="599.5"
      width="95.1467"
...
const DormsSign: React.FC<{ onClick: () => void }> = ({ onClick }) => (
...
const ProfessorsSign: React.FC<{ onClick: () => void }> = ({ onClick }) => (
  <ClickableContainer onClick={onClick}>
    <rect
      x="709.427"
      y="243.5"
      ...
      strokeWidth="3"
    />
    <rect x="711.534" y="245.5" width="90.931" height="32" stroke="#FF9393" />
    <rect
      x="695"
      y="278.11"
      width="124"
...
const Professors: React.FC<{ onClick: () => void }> = ({ onClick }) => (
  <ClickableContainer onClick={onClick}>
    ...
    <path d="M622.125 133H679.625L699 156H604L622.125 133Z" fill="#B24747" />
    <rect x="639.739" y="127" width="19.1739" height="24.6522" fill="#B24747" />
    <rect
      x="642.478"
      y="129.739"
      width="13.6957"
    ...
    <rect
      ...
      fill="#A6DFEA"
    />
    <rect x="637" y="146.174" width="24.6522" height="2.73913" fill="#FF6667" />
    <path d="M649.5 118L661.191 127H637.809L649.5 118Z" fill="#FF6667" />
  </ClickableContainer>
)

const MainCampus: React.FC<{ setMapLocation: (location: string) => void }> = ({
  setMapLocation
}) => (
  <React.Fragment>
    <g clipPath="url(#clip0)">
      ...
      <g mask="url(#mask0)">
        ...
        <rect
          ...
          fill="#CC8427"
        />
        <DormsBuilding setMapLocation={() => setMapLocation('dorms')} />
        <DormsSign onClick={() => setMapLocation('dorms')} />
        <ProfessorsSign onClick={() => setMapLocation('professors')} />
        <RitchieHallSign onClick={() => setMapLocation('ritchie-hall')} />
        <Professors onClick={() => setMapLocation('professors')} />
